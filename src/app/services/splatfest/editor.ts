...
import { SplatfestEtcParams, SplatfestModel, SplatfestNewsScript, SplatfestRotation, SplatfestTeams, SplatfestTime } from "../../common/types/splatfest/splatfest-model";
